...
public class WisataEdukasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] values = new String[]{"Kebun Binatang Bandung","Perpustakaan Soeman H.S","Museum Geologi Bandung","Farmhouse Lembang Bandung", "Taman Bunga Begonia Lembang","De Ranch","Trans Studio Bandung","Kebun Strawberry Ciwidey Bandung","Taman Lalu Lintas","Bandung Science Centre"
